...
from .models import Admins, Articulos, Cliente, Comentarios, Estudiantes
from django .forms import forms
from .forms import FormAdmins, FormArticulos, FormComentarios, FormEstudiante
from  django.forms import forms
...
class articulosView(CreateView):
    model= Articulos
    form_class=FormArticulos
    template_name='articulos.html'
    success_url=reverse_lazy('jesus:articulos')
...
class ComentariosView(CreateView):
    ...
    success_url=reverse_lazy('jesus:Comentarios')
        
        # return Cliente.objects.filter(nombre = 'carlos')

class ListarComentarios(ListView):
    template_name = 'Listar_Comentarios.html'
    model = Comentarios
